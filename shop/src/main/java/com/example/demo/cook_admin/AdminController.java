...
import com.example.demo.cook_notice.NoticeService;
...
// ==================== Category ====================
   ...
   public ModelAndView updateCategory(@RequestParam(value = "category_type") int category_type,
      ...
      System.out.println("수정 ca_num : " + ca_num);
      System.out.println("수정 category_type : " + category_type);
      System.out.println("수정 ca_name : " + ca_name);
   ...
   public ModelAndView updateCategory(@RequestParam(value = "category_type") int category_type,
         @RequestParam(value = "ca_num") int ca_num) {
      System.out.println("삭제용 ca_num : " + ca_num);
