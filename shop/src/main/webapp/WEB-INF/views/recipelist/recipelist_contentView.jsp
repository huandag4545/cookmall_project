...
<head>
	<meta charset="UTF-8">
	<!-- CSS -->
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/recipelist/recipelist_contentView.css?after">
	<!-- Jquery -->
...
<body>
	...
	<form id="contentForm" action="${pageContext.request.contextPath }" style="display: table; margin-left: auto; margin-right: auto;">
		...
		<table>
			<tr>
				<th class="recipelist_wirter_id"></th>
				<c:if test="${sessionScope.user_type == 1 || 2 }">
					<th class="title"><input class="title_text_box" type="text" name="rl_title" value="${r.rl_title }"></th>
				</c:if>
				
				<th class="YMD">${r.rl_date }</th>
			</tr>
