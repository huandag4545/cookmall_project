...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/user/registerAgree(css).css?after">
	
	<!-- Jquery -->
	<script src="http://code.jquery.com/jquery-latest.min.js"></script>
	
	<!-- registerAgree스크립트 -->
	<script src="${pageContext.request.contextPath }/assets/js/user/signup_agree.js?after"></script>
...
이메일 주소 : sellerHelp@naver.com
        ...
        <div class="promotion_agree">
            <input type="checkbox" class="Service_Check_1"> &nbsp; 이벤트/혜택 수신 동의 (선택)
            <br /><br />
            <textarea class="promotion_content" readonly>
쿠킹몰에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(쿠킹몰앱 알림 또는 문자), 이메일로 받아보실 수 있습니다.
일부 서비스(별도 회원 체계로 운영하거나 쿠킹몰 가입 이후 추가 가입하여 이용하는 서비스 등)의 경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고 동의를 받습니다.
            </textarea>
        </div>
        <br />
