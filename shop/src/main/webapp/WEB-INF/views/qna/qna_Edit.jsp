	...
	<form method="post" id="QnA_Edit_Form">
		<table class="QnA_Writing_Table">
	       ...
	       <c:if test="${sessionScope.user_type ==2}">
		        <tr>
		        <td class="qna_content_td_1">
	            	<label class="qna_content_lable">*답변</label>
	            </td>
	            <td class="qna_content_td_2">
	                <textarea class="qna_content" name="qna_content">답변: </textarea>
	            </td>
	        	</tr>
        	</c:if> 
	        ...
	        <tr>
	            <td class="qna_btn_td" colspan="2">
	                <input class="qna_cancel_btn" name="qna_cancel_btn" id="qna_cancel_btn" type="button" onClick="history.back();" value="취소">
	                <input class="qna_writing_btn" name="qna_writing_btn" id="qna_writing_btn" type="button" value="완료">
	            </td>
	        </tr>
	    </table>
