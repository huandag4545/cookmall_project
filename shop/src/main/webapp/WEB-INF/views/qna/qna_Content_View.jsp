...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/qna/qna_Content_View.css?after">
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/qna/qna_Button.css?after">
		...
		<table class="QnA_Content_View_Table">
	        ...
	        <tr>
	            <td class="QnA_Content_View_td">
	                <textarea class="QnA_Content_View_Text" name="qna_content" disabled> ${q.qna_content }
          ...
          <c:if test="${sessionScope.user_type ==2}">
		        <tr>
		            <td class="QnA_Edit_Btn_td">
		            <!--      <input type="button" class="QnA_Content_re_btn" id="QnA_Content_re_btn" value="답변하기">--> 
						<input type="button" class="QnA_Content_Edit_btn" id="QnA_Content_Edit_btn" value="답변하기">
		            </td>
	        	</tr>
        	</c:if>
