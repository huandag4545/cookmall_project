...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/qna/qna_List.css?after">
         ...
         <tr>
              ...
              <c:choose>
              	<c:when test="${empty sessionScope.user_type }">
	               	<button class="QnA_content_btn" onClick="alert('로그인 해주세요'); return false;">등록된 QnA가 없습니다. 작성 버튼을 눌러 등록하세요.</button>
              	</c:when>
      ...
      <c:if test="${sessionScope.user_type == 1 }">
           <tr>
               <td class="writing_btn_td">
    	           	<a href="${pageContext.request.contextPath }/qna/qna_WritingForm">
        	           <input class="qna_writing_btn" name="qna_writing_btn" type="button" value="Q&A작성">
	               	</a>	
               </td>
           </tr>
        </c:if> 
